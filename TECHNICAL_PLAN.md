...
> 项目代号：TeachMe（基于 TeachAny 二次开发）
> 版本：v1.0 · 2026-06-26
> 目标：完全替代课外辅导班，一个学生从初二用到中考
...
### Phase 1 · MVP（第1-2周）— 能用

> 目标：学生可以做诊断测试 + 看课件 + 做题，家长能看基本数据

- [ ] 搭建FastAPI + Vue3项目骨架
- [ ] 部署Docker Compose + Nginx
- [ ] 导入初二数学知识树（约40个核心知识点）
- [ ] 实现入学诊断卷（数学）
- [ ] 用TeachAny生成5-10个重点知识点课件（含TTS）
- [ ] 实现基础做题功能（答题+判分+错因提示）
- [ ] 实现简版每日计划（手动规划）
- [ ] 家长看板：今日时长+正确率

**MVP交付物：** 学生暑假可以开始用，先攻数学

### Phase 2 · 核心能力（第3-4周）— 好用

> 目标：智能推题、自动生成学习路径、错题本
